export const personalInfo = {
  ...
  contact: {
    ...
    linkedin: "linkedin.com/in/ashikeelahi3",
    linkedinUrl: "https://linkedin.com/in/ashikeelahi3",
    facebook: "facebook.com/ashikeelahi3",
    facebookUrl: "https://www.facebook.com/ashikeelahi3",
    youtube: "youtube.com/@ashikeelahi3",
    youtubeUrl: "https://www.youtube.com/@ashikeelahi3"
  }
};

export const aboutMe = `Aspiring Data Scientist with a strong foundation in statistical analysis and data analysis. Passionate about transforming raw data into meaningful insights through innovative solutions. Experienced in R, Python and JavaScript, with expertise in web development, data visualization.`;
...
export const skills = [
  ...
  },
  {
    ...
    items: ["Git/GitHub", "Excel", "PowerPoint", "Linux", "LaTeX", "Prompt Engineering"],
