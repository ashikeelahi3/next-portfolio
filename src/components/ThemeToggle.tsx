...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 p-3 rounded-full bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-200 z-50 border border-gray-200 dark:border-gray-700"
